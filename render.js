// code taken from https://github.com/transitive-bullshit/chatgpt-twitter-bot/blob/main/src/render-response.ts
...
import { logoBase64DataUri } from './logo-base64.js'
...
export async function renderResponse({
  ...
  let responseUserHeader = `<p class="user">Rasbyte</p>`
  ...
  // const footer = `<div class='footer'><img class="logo" src="${logoBase64DataUri}" /> Generated by Rasbyte</div>`
